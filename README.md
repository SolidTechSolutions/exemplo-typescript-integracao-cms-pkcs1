# 🇧🇷 SolidSign API - Exemplo de Integração: Assinatura CAdES (CMS) com PKCS#1 (extensão de navegador, dois passos) (TypeScript)
...
# 🇬🇧 SolidSign API - Integration Example: CAdES (CMS) Signing with PKCS#1 (browser extension, two-step) (TypeScript)
